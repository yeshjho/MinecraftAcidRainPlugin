...
public record Constants()
{
    ...
    public static final int HAZMAT_SUIT_TIER_1_CUSTOM_MODEL_DATA = 1 << 4;
    public static final int HAZMAT_SUIT_TIER_2_CUSTOM_MODEL_DATA = 1 << 5;
    public static final int HAZMAT_SUIT_TIER_3_CUSTOM_MODEL_DATA = 1 << 6;
    public static final int TURTLE_HOE_CUSTOM_MODEL_DATA = 1 << 10;
    ...
    public static final HashSet<Material> ACID_PROOF_MATERIALS = new HashSet<>(Arrays.asList(
            ...
            Material.SMALL_AMETHYST_BUD, Material.MEDIUM_AMETHYST_BUD, Material.LARGE_AMETHYST_BUD, Material.TINTED_GLASS,
            Material.SCUTE
    ));
}
